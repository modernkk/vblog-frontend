                ...
                <el-row style="min-height: 200px">
                  ...
                  >
                    ...
                    >
                      ...
                      <g-link :to="'/socials/' + item.bloguser">
                        {{ item.login }}
                      </g-link>
                      <br />
...
<page-query>
query {
  user: strapiBloguser(id: "5fe44ff215f89523d7937a84") {
    id
    login
    avatar {
      url
...
export default {
  ...
  computed: {
    ...
    followers () {
      return {
        list: this.$page.user.followers
      }
    },
    following () {
      return {
        list: this.$page.user.followings
      } 
    }
  },
  mounted() {
